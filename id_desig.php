  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Designation Management</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Manage All User Designation</h3>
                  ...
                  <tbody>
                    <?php 
                      ...
                      if (isset($_GET['active'])) {
                        $id =$_GET['active'];
                        $idCard->desig_active($id); 
                      }
                      if (isset($_GET['inactive'])) {
                        $id =$_GET['inactive'];
                        $idCard->desig_inactive($id); 
                      }
                      if (isset($_GET['id'])) {
                        $id =$_GET['id'];
                        $idCard->desig_delete($id); 
                      }

                      $obj = $idCard->findDesig();
                      if($obj->num_rows > 0){
                        while($row = $obj->fetch_assoc()){ 
                          if ($row["status"] == 1) {
                            $status = '<a href="id_desig.php?active='.$row["id"].'" name="active" class="btn btn-success btn-sm"><i class="fa-solid fa-toggle-on"></i></a>';
                          }
                          else{
                            $status = '<a href="id_desig.php?inactive='.$row["id"].'" name="inactive" class="btn btn-secondary btn-sm btn-outline-light"><i class="fa-solid fa-toggle-off"></i></a>';
                          }
                         ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="id_desig.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger">Confirm</a>
                        </div>
                    </div>
                </div>
            </div>
              ...
              echo $idCard->desig_add($_POST);
               ...
               ?>
                ...
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" name="desig_name" id="desig_name" placeholder="Enter New Designation">
                </div>
