...
if (isset($_POST['addmember']))
{
    if ($_POST['memail'] != '' && $_POST['mfname'] != '' && $_POST['msname'] != '' && $_POST['mphone'] != '' && $_POST['minstitution'] != '' && $_POST['mpassword'] != '')
    {
        ...
        if ($found == 0)
        {
            ...
            $query = "INSERT INTO Users (Firstname,Sirname,Mtitle,Email,Staffid,Rank,Department,Online,Picname) " . "VALUES ('$mfname','$msname', '$mtitle','$mphone','$mpassword','$memail','$minstititution','Offline','$orgName')";
...
if (isset($_POST["bulk"]))
{
    ...
    while (($filesop = fgetcsv($handle, 1000, ",")) !== false)
    {
        ...
        if ($count > 1)
        {
            $query = "INSERT INTO Users (Firstname,Sirname,Mtitle,Email,Staffid,Rank,Department) " . "VALUES ('$mfname','$msname', '$mtitle','$mphone','$sid','$rank','$minstititution')";
            $db->query($query) or die('Error1, query failed');
