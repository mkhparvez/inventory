...
function __construct($orientation='P', $unit='mm', $size=array(54, 86)) {

	parent::__construct($orientation,$unit,$size);

	$this->SetMargins(2, 2, 2); // Set all margins to 0
    $this->SetAutoPageBreak(false); // Disable automatic page break
