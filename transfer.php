              ...
              if (isset($_POST['transfer'])) {
               ...
               ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="inv_id" id="inv_id" placeholder="Enter Inventory Id"  value="<?php echo $inv_Id ?>">
                  </div>


                  <div class="form-group">
                    <label for="sl_no">Serial Number</label>
                    <input type="text" readonly class="form-control" name="sl_no" id="sl_no" placeholder="Enter Serial Number"  value="<?php echo $row['sl_no'] ?>">
                  </div>
 

                  <div class="form-group">
                    <label for="user">Present User</label>
                      <input type="text" readonly class="form-control" name="user" id="user" placeholder="Enter Asset Users Name" value="<?php echo $row['user'] ?>">
                  </div>


                  <div class="form-group">
                    <label for="dept">Department</label>
                      <input type="text" readonly class="form-control" name="dept" id="dept" placeholder="Enter Asset Users Name"  value="<?php echo $row['dept'] ?>">
                  </div>

                  <div class="form-group">
                    <label for="location">Present Location</label>
                      <input type="text" readonly class="form-control" name="location" id="location" placeholder="Enter Current Location"  value="<?php echo $row['location'] ?>">
                  </div>       
