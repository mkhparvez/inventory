        ...
        <div class="row">
          <div class="col-md-8 offset-md-2">
           ...
           <!--  -->
                    ...
                    <select disabled class="form-control" id="product_cat" name="product_cat">
                        <?php
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="brand" id="brand" placeholder="Enter Brand" value="<?php echo $row['brand'] ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="model">Model</label>
                    <input type="text" class="form-control" name="model" id="model" placeholder="Enter Model" value="<?php echo $row['model'] ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="sl_no">Serial Number</label>
                    <input type="text" class="form-control" name="sl_no" id="sl_no" placeholder="Enter Serial Number" value="<?php echo $row['sl_no'] ?>" readonly>
                  </div>
                  <div class="form-group processor">
                    <label for="processor">Processor Type</label>
                      <select class="form-control" id="processor" name="processor" value="<?php echo $processor?>" disabled>
                  ...
                  <div class="form-group ram">
                    <label for="ram">RAM Size</label>
                      <select class="form-control" id="ram" name="ram" disabled>
                  ...
                  <div class="form-group hdd">
                    <label for="hdd">Storage Size (HDD/SSD)</label>
                      <input type="text" class="form-control" name="hdd" id="hdd" placeholder="Enter HDD/SSD Size"value="<?php echo $row['hdd'] ?>" readonly>
                  </div> 

                  <div class="form-group mon_size">
                    <label for="mon_size">Monitor Size</label>
                      <input type="text" class="form-control" name="mon_size" id="mon_size" placeholder="Monitor Size in Inch" value="<?php echo $row['mon_size'] ?>" readonly>
                  </div>  
                  <div class="form-group toner">
                    <label for="toner">Toner Number</label>
                      <input type="text" class="form-control" name="toner" id="toner" placeholder="Input Printer Toner Number" value="<?php echo $row['toner'] ?>" readonly>
                  </div>  
                  <div class="form-group va">
                    <label for="va">UPS Capacity(KVA)</label>
                      <input type="text" class="form-control" name="va" id="va" placeholder="Input UPS Capacity" readonly>
                  </div>
                    ...
                    <label for="port">Number of Port</label>
                      <select class="form-control" id="port" name="port" disabled>
                  ...
                  <div class="form-group port_type">
                    <label for="port_type">Port Type(POE / Non POE)</label>
                      <select class="form-control" id="port_type" name="port_type" disabled>
                   ...
                   <div class="form-group cam_type">
                    <label for="cam_type">Camera Type</label>
                      <select class="form-control" id="cam_type" name="cam_type" disabled>
                      <option><?php echo $row['cam_type']." Camera" ?></option>
                   ...
                   <div class="form-group cam_res">
                    <label for="cam_res">Camera Resolution</label>
                      <select class="form-control" id="cam_res" name="cam_res" disabled>
                      <option><?php echo $row['cam_res']." Megapixel" ?></option>
                  ...
                  <div class="form-group ip">
                    <label for="ip">IP Address</label>
                      <input type="text" class="form-control" name="ip" id="ip" placeholder="Input IP Address" value="<?php echo $row['ip'] ?>" readonly>
                  </div> 
                  ...
                  <div class="form-group">
                    <label for="user">User Name</label>
                      <input type="text" class="form-control" name="user" id="user" placeholder="Enter Asset Users Name" value="<?php echo $row['user'] ?>" readonly>
                  </div>
                  <div class="form-group user_designation">
                    <label for="user_designation">User Designation</label>
                      <input type="text" class="form-control" name="user_designation" id="user_designation" placeholder="Enter Users Designation" value="<?php echo $row['user_designation'] ?>" readonly>
                  </div>

                  <div class="form-group PF">
                    <label for="PF">PF No</label>
                      <input type="text" class="form-control" name="PF" id="PF" placeholder="Enter Users PF Number" value="<?php if($row['PF']==0){ echo "";} else {echo $row['PF'];} ?>" readonly>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="location">Current Location</label>
                      <input type="text" class="form-control" name="location" id="location" placeholder="Enter Current Location" value="<?php echo $row['location'] ?>" readonly>
                  </div>
                  ...
                  <div class="form-group remarks">
                    <label for="remarks">Remarks</label>
                      <textarea class="form-control" readonly name="remarks" id="remarks"><?php echo $row['remarks'] ?></textarea>
                  </div>           
